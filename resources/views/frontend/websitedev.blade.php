            ...
            <div class="col-lg-12">
               <div class="services-details">
                  <div class="services-details-section ml-95">
                     ...
                     <h4 class="services-details-title" style="color:aliceblue;">Website Development</h4>
                  </div>
                        ...
                        <div class="col-lg-10 offset-lg-1">
                           <div class="services-details-content">
                              <div class="services-details-content-box">
                                 <span>Web Development: We Develop Web Services That Build Your Business</span>
                                 <p>Professional web development is the foundation of a strong online presence—and at Ridgeben IT Solutions, we create websites that do more than just look good; they work for your business.

                                    Develop a simple company profile or a full e-commerce platform. We focus on the business goals with care, speed, and quality.
                                 </p>
                              </div>
                              <div class="services-details-list">
                                 <span>Why Web Development Matters</span>
                                 <p>First impressions matter!</p>
                                 <p>A well-designed, fast, and mobile-friendly website builds good impressions that last longer! It increases trust, boosts sales, and helps people connect more to your business.
                                    In simple words— Your brand value gets established!! </p><br>
                                 <span>What We Offer</span>
                                 <p>Complete web development solutions according to your needs that includes:</p>
                                 <ul class="services-details-list-item">
                                    <li>Customised but fully functional Website Design
                                       Our websites reflect your brand, using colours, fonts, and layouts that speak to your audience.</li>
                                    <li>Responsive Design
                                       Our website supports all desktops, tablets, and phones—so your customers can reach you anytime, anywhere.</li>

                                    <li>E-commerce Development
                                       We build online stores that are easy to use and secure. Also, manage products, accept payments, and grow your sales.</li>

                                    <li>SEO Optimization
                                       No need to be worried about ranking higher on Google! Because we build websites that are fully SEO optimised. You will be found online in no time!!</li>

                                    <li>Website Maintenance
                                       We offer regular updates, security checks, and backups to keep your website running smoothly.</li>
                                 </ul><br>

                                 <span>Technologies We Use</span>
                                 <p>Our team works with the latest technologies, including:</p>

                                 <li>HTML5, CSS3, JavaScript</li>
                                 <li>PHP, Laravel, Python</li>
                                 <li>WordPress, WooCommerce</li>
                                 <li>React, Vue.js, Node.js</li>
                                 <li>MySQL, MongoDB</li><br>


                                 <p>This allows us to build flexible, secure, and scalable websites for any business.</p><br>

                                 <span>Who We Work With</span>
                                 <p>We support startups, small businesses, and large enterprises. Whether you run a travel agency, retail shop, or service-based company, we have experience building websites in various industries.</p>

                                 <span>Interested in having a professional website?</span>

                                 <p>Contact Ridgeben IT Solutions today for a free consultation and get started with professional web development services that fit your business.</p>
