...
<body>
  ...
  <div class="container" >
    <div class="portfolio-inner-2 text-center mb-50">
      <h2 class="portfolio-inner-2-head" style="color: #004a87; font-size: 36px; font-weight: 700;">12+ Years of Experience</h2>
      <p class="portfolio-inner-2-desc" style="font-size: 18px; color: #6c757d; margin-top: 15px; max-width: 600px; margin-left: auto; margin-right: auto;">
        Our team brings over a decade of expertise in delivering high-quality digital solutions, ensuring we always exceed your expectations.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="brand-slider-container col-xl-12 pb-40">
      <div class="brand-slider-content">
        ...
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/1.jpg')}}" alt="Brand 1"></div>
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/3.webp')}}" alt="Brand 2"></div>
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/4.png')}}" alt="Brand 3"></div>
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/5.png')}}" alt="Brand 4"></div>
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/6.png')}} " alt="Brand 5"></div>
        <!-- <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/7.png')}}" alt="Brand 6"></div> -->
         <div class="brand-slider-item">
             <img loading="lazy" src="{{asset('assets/partners/7.png')}}" alt="Brand 6" style="width: 80px; height: auto; object-fit: contain; object-position: center;">
         </div>
        <div class="brand-slider-item"><img loading="lazy" src="{{asset('assets/partners/8.webp')}}" alt="Brand 7"></div>
      </div>
    </div>
  </div>
</section>
...
<section class="services-section pb-110">
        ...
        <div class="services-list">
          <ul class="services-grid">
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/software-development-engineering">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-software"></use></svg> <!-- Code Icon -->
                </div>
                <div class="service-content">
                  <h4 class="service-title">Software Development & Engineering</h4>
                  <p>Custom Software, ERP/CRM, Web Apps, Mobile Apps, Legacy System Modernization, Microservices</p>
                </div>
              </a>
            </li>
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/digital-online-services">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-marketing"></use></svg> <!-- Marketing Icon -->
                </div>
                <div class="service-content">
                  <h4 class="service-title">Digital & Online Services</h4>
                  <p>Web Design, Digital Marketing (SEO, SEM, SMM), E-commerce, Content Management, Social Media</p>
                </div>
              </a>
            </li>
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/cloud-computing-services">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-cloud"></use></svg> <!-- Cloud Icon -->
                </div>
                <div class="service-content">
                  <h4 class="service-title">Cloud Computing Services</h4>
                  <p>Cloud Migration (AWS, Azure), Hybrid & Multi-Cloud, Cloud Security, Serverless Computing</p>
                </div>
              </a>
            </li>
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/devops-it-operations">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-devops"></use></svg> <!-- DevOps Icon -->
                </div>
                <div class="service-content">
                  <h4 class="service-title">DevOps & IT Operations</h4>
                  <p>CI/CD, Containerization, IaC, Performance Monitoring, IT Strategy, Managed IT Support</p>
                </div>
              </a>
            </li>
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/cybersecurity-services">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-cybersecurity"></use></svg> <!-- Shield Icon -->
                </div>
                <div class="service-content">
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/data-analytics-services">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-data-analytics"></use></svg> <!-- Data Analytics Icon -->
                </div>
                <div class="service-content">
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/it-infrastructure-networking">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-web"></use></svg> <!-- Networking Icon -->
                </div>
                <div class="service-content">
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/ai-automation-services">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-ai"></use></svg> <!-- AI/ML Icon -->
                </div>
                <div class="service-content">
            ...
            <li class="service-item">
              <a class="service-box" href="https://www.ridgebenit.com/services/business-process-outsourcing-bpo">
                <div class="service-icon" aria-hidden="true">
                  <svg class="service-svg"><use xlink:href="#icon-ecommerce"></use></svg> <!-- BPO Icon -->
                </div>
                <div class="service-content">
  ...
  <div class="container">
    <div class="rb-funfact-box p-relative">
      <div class="rb-funfact-bg text-center text-white mb-5 p-5" style="background-color: #001f3f; border-radius: 12px;">
        <div class="rb-subtitle mb-3">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="project-card">
          <div class="project-image-wrapper">
            <img src="{{ asset('assets/img/website/Ajwah-Tech-Trusted-Gadget-Ecommerce-of-Bangladesh.png') }}" alt="Ajwah Tech" loading="lazy" class="project-img">
          </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="project-card">
          <div class="project-image-wrapper">
            <img src="{{ asset('assets/img/website/Homeland-Furniture.png') }}" alt="Homeland Furniture" loading="lazy" class="project-img">
          </div>
          <div class="project-content">
            <h4 class="project-title">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="project-card">
          <div class="project-image-wrapper">
            <img src="{{ asset('assets/img/website/Leading-Retail-Computer-Shop-in-Bangladesh.png') }}" alt="EasternIT" loading="lazy" class="project-img">
          </div>
          <div class="project-content">
            <h4 class="project-title">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="project-card">
          <div class="project-image-wrapper">
            <img src="{{ asset('assets/img/website/Magnus.png') }}" alt="Magnus Holdings Ltd." loading="lazy" class="project-img">
          </div>
          <div class="project-content">
            <h4 class="project-title">
  ...
  <div class="project-card dcon-project">
    <div class="project-image-wrapper">
      <img src="{{ asset('assets/img/website/Home-Dcon-Design-Studio.png') }}" alt="Dcon Design Studio" loading="lazy" class="project-img">
    </div>
    <div class="project-content">
      <h4 class="project-title">
        <a href="https://dcon.com.bd/" target="_blank">Dcon Design Studio</a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="project-card">
          <div class="project-image-wrapper">
            <img src="{{ asset('assets/img/website/CTC-Company.png') }}" alt="CTC Energy Sol." loading="lazy" class="project-img">
          </div>
          <div class="project-content">
            <h4 class="project-title">
...
<section class="tech-section py-5" style="background-color: #f5f9ff;">
  <div class="container text-center">
    ...
    <div class="row justify-content-center g-4">
      ...
      {{-- Frontend Development --}}
      <div class="col-12">
        <h4 class="tech-category-title" style="font-size: 20px; font-weight: 600; color: #4a5fc1; margin-top: 10px; margin-bottom: 5px;">Frontend Development</h4>
      </div>
      @foreach (['react', 'angular', 'vuejs', 'bootstrap'] as $tech)
        <div class="col-4 col-sm-3 col-md-2">
          <div class="tech-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
      ...
      {{-- Backend Development --}}
      <div class="col-12 mt-5">
        <h4 class="tech-category-title" style="font-size: 20px; font-weight: 600; color: #4a5fc1; margin-top: 20px; margin-bottom: 5px;">Backend Development</h4>
      </div>
      ...
      <div class="col-12 mt-5">
        <h4 class="tech-category-title" style="font-size: 20px; font-weight: 600; color: #4a5fc1; margin-top: 20px; margin-bottom: 5px;">Mobile App Development</h4>
      </div>
      ...
      {{-- E-commerce --}}
      <div class="col-12 mt-5">
        <h4 class="tech-category-title" style="font-size: 20px; font-weight: 600; color: #4a5fc1; margin-top: 20px; margin-bottom: 5px;">E-commerce</h4>
      </div>
...
<section class="industry-expertise py-70" style="background-color: #f8f8f8; margin-bottom: 0px; padding-bottom: 20px;">
  <div class="container text-center">
    <h2 class="section-title" style="font-size: 30px; font-weight: 700; color: #1e1e2d;">Industry Expertise</h2>
    <p class="section-subtitle" style="font-size: 16px; color: #7f8fa6; margin-bottom: 40px;">Ridgeben’s expertise spans across industries, helping businesses thrive through innovative digital solutions.</p>
    
    <div class="row justify-content-center g-4">
      <!-- E-commerce and Retail -->
      <div class="col-lg-3 col-md-4 mb-4">
        <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
          <i class="fas fa-shopping-cart" style="font-size: 40px; color: #4a5fc1;"></i>
          <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">E-commerce and Retail</h4>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4 mb-4">
        <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
          ...
          <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Education and E-learning</h4>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4 mb-4">
        <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
          ...
          <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Finance and Banking</h4>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4 mb-4">
        <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
          ...
          <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Travel and Hospitality</h4>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4 mb-4">
        <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
          ...
          <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Manufacturing and Logistics</h4>
        </div>
      </div>
       <!-- Healthcare and Pharmaceuticals -->
         ...
         <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
            ...
            <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Healthcare and Pharmaceuticals</h4>
         </div>
         </div>
       <!-- Real Estate and Construction -->
         ...
         <div class="industry-card p-4 text-center" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); transition: all 0.3s;">
            ...
            <h4 class="industry-title" style="font-size: 18px; font-weight: 600; color: #4a5fc1; margin-top: 20px;">Real Estate and Construction</h4>
         </div>
         </div>
    ...
    <p class="section-description" style="font-size: 16px; color: #000000; margin-top: 30px;">
      Despite our international reach, we remain deeply committed to contributing to the local economy. We regularly collaborate with Bangladeshi entrepreneurs and startups to accelerate their growth through digital empowerment.
    </p>
  </div>
</section>
...
<section class="core-values-section py-70" style="background-color: #f9f9f9; margin-top: 0px; padding-top: 20px;">
  <div class="container">
    <div class="text-center mb-40">
      <h2 class="core-values-title" style="font-size: 28px; font-weight: 700; color: #1e1e2d;">Our Core Values</h2>
      <p class="core-values-subtitle" style="font-size: 14px; color: #7f8fa6;">What Drives Us Forward</p>
    </div>
    <div class="row">
      <!-- Innovation -->
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="core-values-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
          ...
          <p style="font-size: 14px; color: #7f8fa6;">Essential for staying competitive and relevant in the rapidly evolving tech industry, highlighting our creativity and forward-thinking solutions.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="core-values-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
          ...
          <p style="font-size: 14px; color: #7f8fa6;">Keeping the customer at the heart of our operations ensures satisfaction, loyalty, and long-term partnerships.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="core-values-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
          ...
          <p style="font-size: 14px; color: #7f8fa6;">A commitment to quality in every aspect of our business builds trust and positions us as a reliable service provider.</p>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="core-values-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
          ...
          <p style="font-size: 14px; color: #7f8fa6;">Upholding ethical practices and transparency strengthens trust and credibility with clients and stakeholders.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="core-values-card text-center p-4" style="background-color: #fff; border-radius: 15px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
          ...
          <p style="font-size: 14px; color: #7f8fa6;">In the fast-changing tech world, agility is key to seizing new opportunities and overcoming challenges effectively.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-xl-12 col-lg-12">
        <div class="whychoose-wrapper mb-30">
          <div class="whychoose-header text-center mb-50">
            ...
            <p class="whychoose-desc">Our priority is delivering genuine results. You’ll experience meaningful growth, visible value, and true business success.</p>
          </div>
          ...
          <div class="row gx-4 gy-4">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/1.png')}}" alt="Performance" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Performance-Driven Results</h5>
                <p class="whychoose-card-desc">Every strategy we deliver is ROI-focused, built to drive growth and measurable results.</p>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/2.png')}}" alt="Device Design" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Device-Ready Design</h5>
                <p class="whychoose-card-desc">Our responsive designs adapt perfectly, ensuring flawless performance on all devices.</p>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/3.png')}}" alt="Security" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Ironclad Data Security</h5>
                <p class="whychoose-card-desc">Your data is protected with enterprise-grade security and 24/7 real-time monitoring.</p>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/4.png')}}" alt="SEO" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Search-Optimized Visibility</h5>
                <p class="whychoose-card-desc">Boost your visibility and ranking with optimized content and smart SEO strategies.</p>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/5.png')}}" alt="Scalable Solutions" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Future-Ready Solutions</h5>
                <p class="whychoose-card-desc">Our solutions scale seamlessly—from agile startups to growing enterprise businesses.</p>
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <a href="{{route('about')}}" class="whychoose-card">
                <div class="whychoose-icon mb-20">
                  <img src="{{asset('assets/img/icon/6.png')}}" alt="Support" style="height: 60px; width: auto; object-fit: contain;">
                </div>
                <h5 class="whychoose-card-title">Reliable Long-Term Support</h5>
                <p class="whychoose-card-desc">We’re dedicated to offering continuous support and strategic improvements.</p>
              </a>
            </div>
            <!-- Card Item End -->
          </div>
          ...
          <div class="testimonial-card">
            <div class="testimonial-body">
              ...
              <p class="testimonial-text">
                Partnering with Ridgeben IT Solutions has greatly improved our Furniture business through a dynamic website.
            ...
            <div class="testimonial-footer d-flex align-items-center gap-3">
              <img src="{{ asset('assets/img/banner/pabel.png') }}" alt="Md. Rubel Ahmed" class="testimonial-avatar">
              <div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-card">
            <div class="testimonial-body">
              <div class="testimonial-quote">“</div>
              <p class="testimonial-text">
                We are highly impressed with the website Ridgeben IT Solutions created for Kinglet BD. It's modern, fast, and
                reflects our brand perfectly. Their team was efficient, responsive, and truly understood our goals.
              </p>
            </div>
            <div class="testimonial-footer d-flex align-items-center gap-3">
              <img src="{{ asset('assets/img/team/diran.png') }}" alt="Md. Diran Khan" class="testimonial-avatar">
              <div>
...
.project-img {
  width: 100%;
  height: 200%; /* Make image twice the size of the container to allow scrolling */
  object-fit: cover; /* Ensure the image covers the area without distortion */
  object-position: top center; /* Align the image from the top */
...
.project-card:hover .project-img {
  transform: translateY(-50%); /* Scroll the image up to reveal the full website */
}
...
.project-content {
  ...
  padding: 15px;
  border-radius: 10px;
   transform: translateY(50%); /* Move the content down to avoid overlap with scrolling content */
...
.dcon-project .project-img {
  object-fit: contain; /* Ensure it shows the whole image */
  height: auto; /* Let the image height adjust to maintain the aspect ratio */
  width: 100%; /* Keep the width to fill the card */
  transform: none; /* Disable scrolling effect */
}
...
@media (max-width: 767px) {
  ...
  .project-img {
    height: 300%; /* Increase height for mobile so the scroll effect is more visible */
  }
}
...
<svg width="0" height="0" style="position:absolute;left:-9999px;visibility:hidden" aria-hidden="true">
  ...
  <symbol id="icon-software" viewBox="0 0 24 24">
    ...
    <path d="M8 9l-2 3 2 3M16 9l2 3-2 3M11 16h2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </symbol>

  <!-- Web Development -->
  <symbol id="icon-web" viewBox="0 0 24 24">
    <circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <path d="M3 12h18M12 3a15 15 0 010 18M12 3a15 15 0 000 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  </symbol>
  ...
  <symbol id="icon-ecommerce" viewBox="0 0 24 24">
    ...
    <path d="M3 4h2l2.2 10.5a2 2 0 002 1.5h6.6a2 2 0 002-1.5L20 8H7" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </symbol>
  ...
  <symbol id="icon-marketing" viewBox="0 0 24 24">
    ...
    <path d="M13 9l7-3v12l-7-3M6 13l1.5 5" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  </symbol>

  <!-- Cloud Service -->
  <symbol id="icon-cloud" viewBox="0 0 24 24">
    <path d="M7 18h9a4 4 0 000-8 6 6 0 00-11.6 1.5A3.5 3.5 0 007 18z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
  </symbol>
  ...
  <symbol id="icon-cybersecurity" viewBox="0 0 24 24">
    <path d="M12 2l3 7H9l3-7zm0 12v8h-4v-8h4zm0-8v4h-4V6h4z" fill="none" stroke="currentColor" stroke-width="1.5"/>
  </symbol>
...
.services-section {
  --rb-primary:#4C5FD5;      /* royal blue */
  --rb-accent:#6D28D9;       /* deep purple */
  --rb-ink:#0F172A;
  --rb-muted:#475569;
  --rb-bg:#FFFFFF;
  --rb-surface:#F7F9FC;
...
.services-header .services-subtitle span{
  ...
  background: rgba(76,95,213,.08); color:var(--rb-primary);
}
.services-header .services-title{ font-weight:800; color:var(--rb-ink); margin:6px 0; line-height:1.15; }
...
.service-item{ display:block; height:100%; }
.service-box{
  display:flex; flex-direction:column; align-items:center; text-align:center;
  gap:10px; height:100%;
  padding:28px 22px 24px; border-radius:18px; background: linear-gradient(#fff,#fff) padding-box,
    linear-gradient(135deg, rgba(109,40,217,.55), rgba(76,95,213,.55)) border-box;
  border:1px solid transparent; box-shadow:0 6px 18px rgba(15,23,42,.06);
  text-decoration:none;
...
/* Icon vector */
.service-svg{ width:38px; height:38px; color:var(--rb-primary); }

/* Titles and text */
.service-title{ font-size:18px; font-weight:700; color:var(--rb-ink); margin:0; letter-spacing:.2px; }
.service-content p{ color:var(--rb-muted); font-size:14px; margin:6px 0 0; }

/* Accessibility focus */
.service-box:focus{ outline: none; }
.service-box:focus-visible{ box-shadow: 0 0 0 3px rgba(76,95,213,.35); }

/* Responsive */
@media (max-width:575px){
  .services-section{ padding-top:60px; padding-bottom:80px; }
  .service-box{ padding:24px 18px; }
}
@media (prefers-reduced-motion: reduce){ .service-box{ transition:none; } }
